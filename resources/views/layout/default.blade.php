...
<!--begin::Head-->
<head>
    <title>@yield('title', $pageTitle ?? '') - Web Prosedur Alat Dasar</title>
    ...
    <style>
        ...
        #status {
            ...
            background-image:url("https://unj.ac.id/wp-content/uploads/2025/02/UNJ-LOGO-512-PX-1.png");
            z-index: 9999;
                ...
                <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <a href="{{ url('application/dashboard') }}" class="d-lg-none">
                            <img alt="Logo Triadhipa Logistics White" src="https://unj.ac.id/wp-content/uploads/2025/02/UNJ-LOGO-512-PX-1.png" class="h-30px" />
                        </a>
                    </div>
                    <!--end::Mobile logo-->
                ...
                <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
                    ...
                    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                        ...
                        <a href="{{  url('application/dashboard') }}">
                            <img alt="Logo Triadhipa Logistics Brand" src="https://unj.ac.id/wp-content/uploads/2025/02/UNJ-LOGO-512-PX-1.png}" class="h-60px app-sidebar-logo-default" />
