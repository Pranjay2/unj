...
<head>
    ...
    <!-- Favicons -->
    <link href="https://unj.ac.id/wp-content/uploads/2025/02/UNJ-LOGO-512-PX-1.png" rel="icon">v
    <meta charset="utf-8" />
                            ...
                            <tbody>
                                        ...
                                        <div style="text-align:center; margin:0 15px 34px 15px">
                                            ...
                                            <div style="margin-bottom: 10px">
                                                <a href="https://trd.co.id/triadhipa/" rel="noopener" target="_blank">
                                                    <img alt="Web Prosedur Alat Dasar Logo" src="{{ $message->embed(public_path() . '/img/triadhipa-logo-white.jpg') }}" style="height: 70px" />
                                                </a>
                                            </div>
                                            <!--end:Logo-->
                                            <!--begin:Media-->
                                            ...
                                            <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                                                ...
                                                <p style="margin-bottom:2px; color:#7E8299">Terimakasih telah bergabung menggunakan aplikasi Web Prosedur Alat Dasar. <br> Selamat beraktivitas!</p>
                                            </div>
                                            <!--end:Text-->
                                ...
                                <tr>
                                    <td align="center" valign="center" style="font-size: 13px; padding:0 15px; text-align:center; font-weight: 500; color: #A1A5B7;font-family:Arial,Helvetica,sans-serif">
                                        <p>&copy; Web Prosedur Alat Dasar.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
