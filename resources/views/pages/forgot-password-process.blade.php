...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="description" content="Web Prosedur Alat Dasar, We care your shipments, we care your business growth" />
    <meta name="keywords" content="trd, trd.co.id, Triadhipa, Logistics, Web Prosedur Alat Dasar, Zamasco" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="Web Prosedur Alat Dasar" />
    <meta property="og:url" content="https://trd.co.id/triadhipa/" />
    <meta property="og:site_name" content="Web Prosedur Alat Dasar" />
        ...
        <div class="d-flex flex-column flex-column-fluid flex-lg-row">
            ...
            <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10 logo-space">
                ...
                <div class="d-flex flex-center flex-lg-start flex-column">
                    ...
                    <!--end::Logo-->
                    <!--begin::Title-->
                    <h2 class="text-white fw-normal m-0">Web Prosedur Alat Dasar</h2>
                    <!--end::Title-->
                </div>
                <!--begin::Aside-->
            </div>
